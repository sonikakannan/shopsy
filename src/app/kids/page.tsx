...
const mens_data = [
    { id: 25, image: product_25 },
    { id: 26, image: product_26 },
    { id: 27, image: product_27 },
    { id: 28, image: product_28 },
    { id: 29, image: product_29 },
    { id: 30, image: product_30 },
    { id: 31, image: product_31 },
    { id: 32, image: product_32 },
    { id: 33, image: product_33 },
    { id: 34, image: product_34 },
    { id: 35, image: product_35 },
    { id: 36, image: product_36 },
];
...
const Mens = () => {
    ...
    return (
        <section>
            {/* Header section */}
            <div className='mb-5'>
                <Image src={banner_kids} alt='Kids Banner' />
            </div>
            ...
            <div className='flex flex-wrap gap-5 justify-center items-center'>
                {mens_data.map((data) => (
                    <div key={data.id}>
                        ...
                        >
                            <Image src={data.image} alt={`Kids's Wear ${data.id}`} className='w-[280px] h-[280px] border border-slate-200 rounded-md' />
